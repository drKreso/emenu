...
Live example can be tried at http://emenu.12ip.net. Open it in a new tab or otherwise prepare to click 'Back' quite a few times.
...
* Excluding of menu items based on authorisation
