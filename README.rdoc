...
Live example can be checked out at http://emenu.12ip.net if my home based server is not down again. I suggest to open demo it in a new tab, otherwise prepare to click 'Back' button quite a few times.

It builds menu presentation from configuration and persists state via hidden field. Main goal is to hide as much as possible of the HTML/jQuery ugliness from your tender eyes. Evenly important, at least for me, is to make you balls-of-brass-kind-of-guy when customer is asking for yet another exception/addition in menu layout.
...
This is needed in ApplicationController

   ... 
   include Emenu

   #menu definition, this can be factory or whatever you need
   #I am looking for a suitable place for this, but now it's housed in ApplicationController
   def menu
     menu = MenuConfig.new
...
Be aware that I've monkey patched String class with 'indent' method for my testing purposes. I am not proud of it so I had to come clean :)
